    ...
    extend: {
      ...
      keyframes: {
        ...
        growIn: {
          ...
          "100%": { transform: "scale(1.5) translate(11px, -2px)", opacity: 1 },
        },
        typing: {
          from: { width: "0" },
          to: { width: "100%" },
      ...
      animation: {
        ...
        "flip-scale-in": "flip-scale-in 500ms ease-in-out forwards",
        "flip-scale-out": "flip-scale-out 500ms ease-in-out forwards",
        "flip-in": "flip-in 500ms ease-in-out forwards",
        "flip-out": "flip-out 500ms ease-in-out forwards",
        growIn: "growIn 300ms ease-out forwards",
        ...
        shrinkInOut: "shrinkInOut 400ms ease-in-out forwards",
